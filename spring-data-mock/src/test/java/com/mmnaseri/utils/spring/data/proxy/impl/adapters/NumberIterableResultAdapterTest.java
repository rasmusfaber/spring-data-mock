...
public class NumberIterableResultAdapterTest {
    ...
    public void testAccepting() throws Exception {
        ...
        assertThat(adapter.accepts(new ImmutableInvocation(ReturnTypeSampleRepository.class.getMethod("findInt"), new Object[]{}), new Object()), is(false));
        assertThat(adapter.accepts(new ImmutableInvocation(ReturnTypeSampleRepository.class.getMethod("findInt"), new Object[]{}), Arrays.asList("", 1)), is(false));
        assertThat(adapter.accepts(new ImmutableInvocation(ReturnTypeSampleRepository.class.getMethod("findInt"), new Object[]{}), Arrays.asList(1, 2)), is(false));
        assertThat(adapter.accepts(new ImmutableInvocation(ReturnTypeSampleRepository.class.getMethod("findInt"), new Object[]{}), Collections.singletonList(1)), is(true));
        assertThat(adapter.accepts(new ImmutableInvocation(ReturnTypeSampleRepository.class.getMethod("findInteger"), new Object[]{}), Collections.singletonList(1)), is(true));
    }
    ...
    public void testAdaptingUnsupportedNumberType() throws Exception {
        final NumberIterableResultAdapter adapter = new NumberIterableResultAdapter();
        adapter.adapt(new ImmutableInvocation(ReturnTypeSampleRepository.class.getMethod("findBigDecimal"), new Object[]{}), Collections.singletonList(1));
    }
}
